...
int main() 
{
    ...
    //if we wants to access the block then there must be thaṭ you must puchback the value or give it with a index
...
// //2d array craeted with 5 rows and 4 columns
// cout << totalRows << endl;
// cout << totalColumns<<endl;
  ...
  //to find the max size that can be taken to array
//   cout << marks.max_size() << endl;

  //this is to reserve the minimum capacity of the array/vector
//   marks.reserve(10);
...
//hence this is used to find how many blocks are being given to a array
    ...
    //and this a rule to print this syntax
...
//this element i sused to swap all elements with theseecond element
    //         first.swap(second);

    //         cout << first[0] << endl;

    //         // this is for printing the whole array into the terminal
    //          
